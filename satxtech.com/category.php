...
<?php require('./components/_links.php');?>
  <title>Satxtech.com | Free Movies & web series | all Categories HD Movies </title>
</head>
<body>
<header>
...
if ($_SERVER['REQUEST_METHOD']== 'GET') {
  $movie_category = htmlspecialchars(mysqli_real_escape_string($conn,$_GET['category']));
  $sql_query = "SELECT * FROM movies_details WHERE movie_category = '$movie_category' ";
  $result = mysqli_query($conn,$sql_query);
  if (mysqli_num_rows($result) > 0) {
     echo' 
     <div class="container">
        <div class="sub-heading-wraper">
          <h3 class="sub-heading">'.$movie_category.'</h3>
